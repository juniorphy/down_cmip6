...
'AWI-CM-1-1-MR':                               [   'AWI-CM-1-1-MR',   'r1i1p1f1',      'esgf-data04.diasjp.net'], # gn
'BCC-CSM2-MR':                                 [     'BCC-CSM2-MR',   'r1i1p1f1',              'aims3.llnl.gov'], # gn
'CAS-ESM2-0':                                  [      'CAS-ESM2-0',   'r1i1p1f1',              'esg.lasg.ac.cn'], # gn
'CIESM':                                       [           'CIESM',   'r1i1p1f1',      'esgf-data04.diasjp.net'], # gr
...
'EC-Earth3-Veg':                               [   'EC-Earth3-Veg',   'r1i1p1f1',         'esgf-data1.llnl.gov'], # gr
'EC-Earth3-Veg-LR':                            ['EC-Earth3-Veg-LR',   'r1i1p1f1',         'esgf-data1.llnl.gov'], # gr
'FGOALS-g3':                                   [       'FGOALS-g3',   'r1i1p1f1',         'esgf-data1.llnl.gov'], # gn
'FIO-ESM-2-0':                                 [     'FIO-ESM-2-0',   'r1i1p1f1',         'esgf-data1.llnl.gov'], # gn
'GFDL-ESM4':                                   [       'GFDL-ESM4',   'r1i1p1f1',       'esgdata.gfdl.noaa.gov'], # gr1
'INM-CM4-8':                                   [       'INM-CM4-8',   'r1i1p1f1',             'esgf.ceda.ac.uk'], # gr1
'INM-CM5-0':                                   [       'INM-CM5-0',   'r1i1p1f1',             'esgf.ceda.ac.uk'], # gr1
