...
from dict_models_cmip6_proj_amon import CMIP6_param_amon, CMIP6_param_daily #dicionario modelos diarios
import argparse
...
parser.add_argument('--freq', type=str, default='Amon', 
...
if __name__ == '__main__': 
    ...
    for model in dicionario.keys():
        ...
        '''
        proj, source, experiment, variable, table, variant, node = set_param (experiment, frequency)
